                                    ...
                                    ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <p class="mb-0 text-muted"><small><span>user id: </span><?php echo $data['user_id']?></small></p>
                                                    </td>
                                                    ...
                                                    <td class="d-flex justify-content-center">  <a href="invoice.php?id=<?php echo $data['user_id']?>"><h3><i class="mdi mdi-file-document-box"></i></h3></a>
                                                    </td>

                                                    <td>
                                                        <a href="payment_edit.php?id=<?php echo $data['user_id']?>" class="btn btn-sm btn-custom"><i class="mdi mdi-border-color"></i></a>
                                                        <a href="delete_payment.php?id=<?php echo $data['user_id']?>" class="btn btn-sm btn-danger"><i class="mdi mdi-delete-forever"></i></a>
                                                    </td>
                                            </tr>
                                        <?php
