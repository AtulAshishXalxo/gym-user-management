                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Users' details</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <a href="user_edit.php?id=<?php echo $data['user_id']?>" class="btn btn-sm btn-custom"><i class="mdi mdi-border-color"></i></a>
                                                    <a href="delete_user.php?id=<?php echo $data['user_id']?>" class="btn btn-sm btn-danger"><i class="mdi mdi-delete-forever"></i></a>
                                                </td>
                                            </tr>
